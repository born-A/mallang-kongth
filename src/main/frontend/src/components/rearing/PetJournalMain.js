...
import BathroomCountInput from './BathroomCountInput';
    ...
    const handleInputClick = (type) => {
        switch (type) {
            ...
            case 'hospital':
                ...
                break;
            case 'memo': // 메모 기록을 클릭했을 때의 동작을 추가합니다.
                ...
                <div className="input-wrapper">
                    <div className="input-container bathroom-amount">
                        ...
                        {showBathroomCountInput ? (
                            <BathroomCountInput onAmountSubmit={(amount) => handleAmountSubmit(amount, 'bathroom')} />
                        ) : null}
                    </div>
                </div>
            </div>
