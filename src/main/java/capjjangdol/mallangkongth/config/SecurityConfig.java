    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/css/**",
                        ...
                        "/js/**",
                        "/scss/**",
                        "/vendor/**","/logout.do/**","/login/**","/logout/**","/login?logout","/members/**","/images/**","/attach/**","/view/**","/upload/**","/index","/","/upload/**","/uploadFile/**","/order/**","/item/**","/pets/**","/auth/**","/hospitalNote/**","/health/**","/walking/**","/water/**").permitAll() //auth/**:login page
                .mvcMatchers(
                        "/",
                        "/css/**",
                        "/images/**",
